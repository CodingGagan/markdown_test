...
* <i class="fa fa-home"></i>[Installation Icon](install-and-configure/install/install.md)
  ...
  * [nOps v2 Install/Upgrade](install-and-configure/install/nOpsv2.md)
  * [Provider Installations](install-and-configure/install/provider-installations/README.md)
    ...
    * [Install nOps on Red Hat OpenShift](install-and-configure/install/provider-installations/openshift-nOps-install.md)
...
* [Navigating the nOps UI](using-nOps/navigating-the-nOps-ui/README.md)
  * [Allocations Dashboard](using-nOps/navigating-the-nOps-ui/cost-allocation/README.md)
    * [Efficiency and Idle](using-nOps/navigating-the-nOps-ui/cost-allocation/efficiency-idle.md)
    * [Network Traffic Cost Allocation](using-nOps/navigating-the-nOps-ui/cost-allocation/network-allocation.md)
  * [Assets Dashboard](using-nOps/navigating-the-nOps-ui/assets.md)
  * [Cloud Cost Explorer](using-nOps/navigating-the-nOps-ui/cloud-costs-explorer/cloud-costs-explorer.md)
    * [Cloud Cost Metrics](using-nOps/navigating-the-nOps-ui/cloud-costs-explorer/cloud-cost-metrics.md)
  ...
  * [Savings](using-nOps/navigating-the-nOps-ui/savings/savings.md)
    * [Actions](using-nOps/navigating-the-nOps-ui/savings/savings-actions.md)
    ...
    * [Persistent Volume Right-Sizing Recommendations](using-nOps/navigating-the-nOps-ui/savings/pv-right-sizing-rec.md)
...
* [Contexts](using-nOps/context-switcher.md)
...
* [Importing nOps Data into Microsoft Power BI](integrations/import-nOps-data-into-microsoft-power-bi.md)
